...
`)])])])])])],-1),H="Single Sign-On (SSO)",F=!1,K={name:"sso",setup(x,{expose:t}){const o={title:"Single Sign-On (SSO)",modularExtension:!1};return t({frontmatter:o}),(L,U)=>{const r=l("router-link"),a=l("docs-wrapper");return i(),c(a,{frontmatter:o},{default:n(()=>[e("div",h,[d,p,g,m,e("p",null,[_,u(r,{to:"/docs/self-hosted/config-options/#sso-oauth2-and-openid"},{default:n(()=>[f]),_:1})]),y,O,S,X,w,E,b,v,I,j,k,D,T,A,C,R,G])]),_:1})}}};export{K as default,F as modularExtension,H as title};
