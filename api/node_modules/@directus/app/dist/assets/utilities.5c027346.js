...
`)])])])],-1),S=e("hr",null,null,-1),E=e("h2",{id:"import-data-from-file"},[s("Import Data from File "),e("a",{class:"header-anchor",href:"#import-data-from-file"},"#")],-1),R=s("Import multiple records from a JSON or CSV file into a collection. Relies on a "),T=e("code",null,"multipart/form-data",-1),w=s(" encoded request, just like regular file uploads. Check "),P=s("Upload a File"),C=s(" for more information."),O=s("The import endpoint expects the file structure to match "),F=s("the export query parameter"),k=s(". For JSON, this is an array of objects, where every object is an item. For CSV, the first line has to be the columns header."),I={class:"two-up"},B={class:"left"},D=e("h3",{id:"request-body-4"},[s("Request Body "),e("a",{class:"header-anchor",href:"#request-body-4"},"#")],-1),M=s("Send the file in a "),G=e("code",null,"multipart/form-data",-1),H=s(" request. See "),L=s("Upload a File"),U=s(" for more information."),V=e("h3",{id:"returns-4"},[s("Returns "),e("a",{class:"header-anchor",href:"#returns-4"},"#")],-1),N=e("p",null,"Empty body.",-1),Q=e("div",{class:"right"},[e("h3",{id:"rest-api-4"},[s("REST API "),e("a",{class:"header-anchor",href:"#rest-api-4"},"#")]),e("pre",null,[e("code",null,`POST /utils/import/:collection
...
`)])])])],-1),be="Utilities",ve=!1,xe="page-reference",Ae={name:"utilities",setup(ge,{expose:o}){const n={title:"Utilities",modularExtension:!1,pageClass:"page-reference"};return o({frontmatter:n}),(ye,qe)=>{const t=r("router-link"),h=r("docs-wrapper");return i(),c(h,{frontmatter:n},{default:a(()=>[e("div",d,[u,p,_,f,m,g,y,q,j,b,v,x,A,S,E,e("p",null,[R,T,w,l(t,{to:"/docs/reference/files/#upload-a-file"},{default:a(()=>[P]),_:1}),C]),e("p",null,[O,l(t,{to:"/docs/reference/query/#export"},{default:a(()=>[F]),_:1}),k]),e("div",I,[e("div",B,[D,e("p",null,[M,G,H,l(t,{to:"/docs/reference/files/#upload-a-file"},{default:a(()=>[L]),_:1}),U]),V,N]),Q]),W,J,X,e("div",Y,[e("div",$,[z,K,Z,e("div",ee,[se,e("p",null,[ae,te,le,ne,re,l(t,{to:"/docs/reference/query"},{default:a(()=>[oe]),_:1}),he]),ie]),ce,de]),ue]),pe,_e,fe,me])]),_:1})}}};export{Ae as default,ve as modularExtension,xe as pageClass,be as title};
