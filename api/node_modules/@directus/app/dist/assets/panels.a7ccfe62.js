...
`)])],-1),L=t("div",{class:"tip hint"},[t("div",{class:"hint-title"},"Vue Options API"),t("p",null,[s("If you prefer to use the Vue Options API, you can inject the "),t("code",null,"api"),s(" and "),t("code",null,"stores"),s(" properties directly.")])],-1),Q="Custom Panels",R=!0,X={name:"panels",setup(G,{expose:i}){const a={title:"Custom Panels",modularExtension:!0};return i({frontmatter:a}),(J,K)=>{const n=l("router-link"),r=l("docs-wrapper");return c(),h(r,{frontmatter:a},{default:e(()=>[t("div",d,[t("blockquote",null,[t("p",null,[p,o(n,{to:"/docs/app/insights"},{default:e(()=>[u]),_:1}),m,o(n,{to:"/docs/getting-started/glossary/#panels"},{default:e(()=>[_]),_:1}),g])]),f,y,j,b,w,t("ul",null,[x,k,t("li",null,[v,T,o(n,{to:"/docs/getting-started/glossary/#material-icons"},{default:e(()=>[A]),_:1}),V]),C,P,I,S,D]),E,B,H,W,z,N,O,U,q,F,L])]),_:1})}}};export{X as default,R as modularExtension,Q as title};
