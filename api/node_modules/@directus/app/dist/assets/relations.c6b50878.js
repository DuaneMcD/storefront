...
`)])])])],-1),K="Relations",X=!1,Y="page-reference",Z={name:"relations",setup(V,{expose:n}){const a={title:"Relations",modularExtension:!1,pageClass:"page-reference"};return n({frontmatter:a}),(H,z)=>{const r=s("router-link"),o=s("docs-wrapper");return i(),c(o,{frontmatter:a},{default:t(()=>[e("div",d,[e("div",p,[e("div",u,[e("blockquote",null,[e("p",null,[g,h(r,{to:"/docs/getting-started/glossary/#relationships"},{default:t(()=>[_]),_:1}),f])])]),m]),y,j,b,q,v,x,w,T,R,E,k,P,S,L,A,N,Q,D,O,G,C,I,B,M,U,W,F])]),_:1})}}};export{Z as default,X as modularExtension,Y as pageClass,K as title};
